...
--
-- Name: properties foreignkey_am; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT foreignkey_am FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties foreignkey_typeid; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT foreignkey_typeid FOREIGN KEY (type_id) REFERENCES public.types(type_id);
